              ...
              try {
                ...
                switch (err.code) {
                  case "auth/email-already-in-use":
                    toast.error(
                      "User already signup with this account. Please try login"
                    );
                    break;
                }
              }
      ...
      <div className={styles.bg_body}>
        <div className={styles.main_div}>
          ...
          <div className={styles.cred_container}>
            ...
            <div className="pt-3">
              <p style={{ color: "#7F95CF" }}>
                Already Have An Account?{" "}
                <button
                  onClick={() => router.push("/src/pages/Login")}
                  style={{ textDecoration: "none", color: "#7F95CF" }}
                >
                  Login
                </button>
              </p>
            ...
            <div className={styles.btn_container}>
              <button
                ...
                onClick={() => router.push(`/src/pages/Login?id=${1}`)}
              >
